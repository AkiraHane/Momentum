...
import static com.akirahane.momentum.platform.config.MomentumServerConfig.*;
...
public abstract class BaseState {
    ...
    protected static final Identifier WALL_GRAVITY_ID =
            Identifier.fromNamespaceAndPath(MomentumConstants.MOD_ID, "wall_gravity");
    // 海豚跳重力
    protected static final Identifier DOLPHIN_GRAVITY_ID =
            Identifier.fromNamespaceAndPath(MomentumConstants.MOD_ID, "dolphin_gravity");
    // 上坡高度ID
    protected static final Identifier UP_SLOPE_ID =
            Identifier.fromNamespaceAndPath(MomentumConstants.MOD_ID, "up_slope");
    // 跳跃
    ...
    public BaseState evaluate(Player player, PlayerMovementContext context) {
        PlatformServices.client().clearHints();
        PlatformServices.client().addHint(MovementHint.ORIGINAL_STATE);
        PlatformServices.client().addHint(MovementHint.TOGGLE_HINT);
    ...
    public static void playStateAnimation(Player player, @NotNull String animName, PlayerMovementContext context, int fadeInTime, float speed) {
        ...
        context.getController().replaceAnimationWithFade(
                ...
                Identifier.fromNamespaceAndPath(MomentumConstants.MOD_ID, animName)
        );
