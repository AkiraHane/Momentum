...
public class ServerConfig {
    ...
    public static void syncToCommon() {
        com.akirahane.momentum.platform.config.MomentumServerConfig.ALLOW_MANEUVER_WITHOUT_BOOSTER.updateFromPlatform(ALLOW_MANEUVER_WITHOUT_BOOSTER.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.MANEUVER_CONSUME_HUNGER.updateFromPlatform(MANEUVER_CONSUME_HUNGER.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.DEFAULT_ENABLE_MANEUVER.updateFromPlatform(DEFAULT_ENABLE_MANEUVER.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.MANEUVER_CONSUME_HUNGER_AMOUNT.updateFromPlatform(MANEUVER_CONSUME_HUNGER_AMOUNT.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.BOOSTER_STAMINA_REDUCTION.updateFromPlatform(BOOSTER_STAMINA_REDUCTION.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.MIN_SLIDE_SPEED.updateFromPlatform(MIN_SLIDE_SPEED.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.MIN_WALL_RUN_SPEED.updateFromPlatform(MIN_WALL_RUN_SPEED.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.MIN_WATER_SWIM_SPEED.updateFromPlatform(MIN_WATER_SWIM_SPEED.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.SLIDE_ACCELERATION_COOLDOWN.updateFromPlatform(SLIDE_ACCELERATION_COOLDOWN.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.DODGE_COOLDOWN.updateFromPlatform(DODGE_COOLDOWN.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.DODGE_STORAGE.updateFromPlatform(DODGE_STORAGE.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.AIR_FRICTION.updateFromPlatform(AIR_FRICTION.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.AIR_ACCELERATION_XZ.updateFromPlatform(AIR_ACCELERATION_XZ.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.CLIMB_BOOST_MULTIPLIER.updateFromPlatform(CLIMB_BOOST_MULTIPLIER.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.WALL_KICK_ACCELERATION_COOLDOWN.updateFromPlatform(WALL_KICK_ACCELERATION_COOLDOWN.get());

        com.akirahane.momentum.platform.config.MomentumServerConfig.ENABLE_PRONE.updateFromPlatform(ENABLE_PRONE.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.ENABLE_SLIDE.updateFromPlatform(ENABLE_SLIDE.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.ENABLE_BREAK_FALL_READY.updateFromPlatform(ENABLE_BREAK_FALL_READY.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.ENABLE_BREAK_FALL.updateFromPlatform(ENABLE_BREAK_FALL.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.ENABLE_DODGE.updateFromPlatform(ENABLE_DODGE.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.ENABLE_WALL_CLIMB.updateFromPlatform(ENABLE_WALL_CLIMB.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.ENABLE_WALL_SLIDE.updateFromPlatform(ENABLE_WALL_SLIDE.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.ENABLE_WALL_RUN.updateFromPlatform(ENABLE_WALL_RUN.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.ENABLE_WALL_HANG.updateFromPlatform(ENABLE_WALL_HANG.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.ENABLE_POWER_JUMP.updateFromPlatform(ENABLE_POWER_JUMP.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.ENABLE_WALL_KICK.updateFromPlatform(ENABLE_WALL_KICK.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.ENABLE_VAULT_UP.updateFromPlatform(ENABLE_VAULT_UP.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.ENABLE_VAULT_IN.updateFromPlatform(ENABLE_VAULT_IN.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.ENABLE_WATER_RUN.updateFromPlatform(ENABLE_WATER_RUN.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.ENABLE_WATER_PUSH.updateFromPlatform(ENABLE_WATER_PUSH.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.ENABLE_FALL_SLOW.updateFromPlatform(ENABLE_FALL_SLOW.get());
        com.akirahane.momentum.platform.config.MomentumServerConfig.ENABLE_AIR_JUMP.updateFromPlatform(ENABLE_AIR_JUMP.get());
    }
}
